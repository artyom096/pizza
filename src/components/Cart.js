...
import cartEmptyImage from '../assets/emptyCart.png'
...
export const Cart = () => {
    ...
    const addedPizza = Object.keys(items).map(item => {
        return items[item][0]
    })
                ...
                totalCount ? (
                    <div className="container container--cart">
                        <div className="cart">
                            <div className="cart__top">
                                ...
                                <div className="cart__clear">
                                    ...
                                    <span onClick={clearCartPizzas}>Очистить корзину</span>
                                </div>
                            </div>
                        ...
                        <div className="cart cart--empty">
                            ...
                            <p>
                                Вероятней всего, вы пока ничего не выбрали
                            </p>
                            <p>
